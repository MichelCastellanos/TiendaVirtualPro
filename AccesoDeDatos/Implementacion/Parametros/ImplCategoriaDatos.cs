...
namespace AccesoDeDatos.Implementacion.Parametros
{
    public class ImplCategoriaDatos
    {
        ...
        /// <returns></returns>
        public IEnumerable<CategoriaDbModel> ListarRegistros(String filtro, int PaginaActual, int numeroRegistroPagina, out int totalRegistros)
        {
            ...
            using (EllaYelDBEntities db = new EllaYelDBEntities())
            {
                ...
                var listaDatos = (from m in db.tb_Categoria
